...
.edit-notice .form-control,
.edit-notice .form-select {
...
.edit-notice .form-control:focus,
.edit-notice .form-select:focus {
    border-color: #667eea;
    box-shadow: 0 0 0 3px rgba(102, 126, 234, 0.1);
}

.edit-notice .file-item {
    transition: all 0.3s ease;
}

.edit-notice .file-item:hover {
    background-color: #f8f9fa;
}

.edit-notice .btn-primary {
...
.edit-notice .btn-primary:hover {
    transform: translateY(-2px);
    box-shadow: 0 4px 12px rgba(102, 126, 234, 0.4);
}

.edit-notice .btn-outline-secondary {
    border: 2px solid #a0aec0;
    color: #4a5568;
    font-weight: 500;
}

.edit-notice .btn-outline-secondary:hover {
    background: #a0aec0;
    color: white;
}

.edit-notice .btn-outline-danger {
    border: 2px solid #f56565;
    color: #f56565;
    font-weight: 500;
}

.edit-notice .btn-outline-danger:hover {
    background: #f56565;
    color: white;
}

.edit-notice textarea {
    min-height: 200px;
}
</style>
